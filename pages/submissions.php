...
.modal-box { background:white; border-radius:18px; max-width:580px; width:94%; box-shadow:0 20px 60px rgba(0,0,0,0.2); overflow:hidden; animation:modalPop 0.28s cubic-bezier(0.34,1.56,0.64,1); }
.modal-box-lg { max-width:860px; width:96%; max-height:92vh; display:flex; flex-direction:column; overflow:hidden; }
.preview-meta-bar { display:grid; grid-template-columns:repeat(4,1fr); border-bottom:1px solid #f0f0f0; background:#f8fafc; flex-shrink:0; }
.preview-meta-bar .meta-item { padding:13px 18px; display:flex; flex-direction:column; gap:4px; border-right:1px solid #f0f0f0; }
...
.preview-viewer-wrap { flex:1; min-height:460px; position:relative; background:#f0f4f8; display:flex; align-items:center; justify-content:center; overflow:hidden; }
.preview-loading { display:flex; flex-direction:column; align-items:center; gap:14px; color:#718096; font-size:0.92em; font-weight:500; }
.preview-spinner { width:40px; height:40px; border:3px solid #e2e8f0; border-top-color:#10b981; border-radius:50%; animation:spin 0.75s linear infinite; }
...
.preview-iframe { width:100%; height:100%; min-height:460px; border:none; background:white; display:block; }
.preview-image { max-width:100%; max-height:520px; object-fit:contain; border-radius:4px; box-shadow:0 4px 20px rgba(0,0,0,0.12); }
...
.btn-modal-download { padding:10px 20px; background:linear-gradient(135deg,#8b5cf6,#7c3aed); color:white; border:none; border-radius:9px; font-weight:600; font-size:0.9em; cursor:pointer; transition:all 0.2s; display:inline-flex; align-items:center; gap:7px; box-shadow:0 3px 10px rgba(139,92,246,0.3); text-decoration:none; font-family:inherit; }
.btn-modal-download:hover { background:linear-gradient(135deg,#7c3aed,#6d28d9); transform:translateY(-1px); color:white; }
.btn-modal-done { padding:10px 20px; background:linear-gradient(135deg,#10b981,#059669); color:white; border:none; border-radius:9px; font-weight:600; font-size:0.9em; cursor:pointer; transition:all 0.2s; display:inline-flex; align-items:center; gap:7px; box-shadow:0 3px 10px rgba(16,185,129,0.3); font-family:inherit; }
.btn-modal-done:hover { background:linear-gradient(135deg,#059669,#047857); transform:translateY(-1px); }
.btn-modal-done:disabled { background:#d1fae5; color:#065f46; cursor:default; transform:none; box-shadow:none; opacity:1; }
@media(max-width:700px) { .preview-meta-bar{grid-template-columns:repeat(2,1fr);} .modal-box-lg{max-height:98vh;width:99%;} .preview-viewer-wrap{min-height:300px;} }
@keyframes modalPop { from{transform:scale(0.92) translateY(20px);opacity:0;} to{transform:scale(1) translateY(0);opacity:1;} }
.modal-header { display:flex; align-items:center; gap:14px; padding:22px 24px 18px; border-bottom:1px solid #f0f0f0; }
